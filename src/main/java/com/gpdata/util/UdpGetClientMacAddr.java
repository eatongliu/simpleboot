...
/**
 * Created by liuyutong on 2017/11/3.
 */
public class UdpGetClientMacAddr {
    private static Logger logger = LoggerFactory.getLogger(UdpGetClientMacAddr.class);
    ...
    public static void main(String args[]) throws Exception{
        ...
        UdpGetClientMacAddr umac = new UdpGetClientMacAddr("176.122.148.104");
